...
const char *my_vertex_shader_source = "#version 330 core\n"
                                      ...
                                      "}\0";
const char *my_fragment_shader1_source = "#version 330 core\n"
                                        "out vec4 FragColor;\n"
                                        "void main()\n"
                                        "{\n"
                                        "   FragColor = vec4(1.0f, 0.5f, 0.2f, 1.0f);\n"
                                        "}\n\0";
const char *my_fragment_shader2_source = "#version 330 core\n"
                                    "out vec4 FragColor;\n"
                                    "void main()\n"
                                    "{\n"
...
auto main() -> int
{
    ...
    // ----------------------------------------
    unsigned int shader_program1_id = compile_shader(my_vertex_shader_source, my_fragment_shader1_source);
    unsigned int shader_program2_id = compile_shader(my_vertex_shader_source, my_fragment_shader2_source);
    unsigned int triangle1_VAO = pass_geometry_data_to_GPU(firstTriangle, sizeof(firstTriangle));
    unsigned int triangle2_VAO = pass_geometry_data_to_GPU(secondTriangle, sizeof(secondTriangle));
    // ----------------------------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // ----------------------------------------
        glUseProgram(shader_program1_id); // 绘制之前一定要指定使用哪个shader program
        ...
        glUseProgram(shader_program2_id);
