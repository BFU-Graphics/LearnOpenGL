...
auto main() -> int
{
    ...
    Shader shader(MY_SHADER_DIR + std::string("07shader_vertex.glsl"), MY_SHADER_DIR + std::string("07task5_shader_fragment.glsl"));
    Texture texture1(MY_TEXTURE_DIR + std::string("awesomeXayah.jpg"));
    Texture texture2(MY_TEXTURE_DIR + std::string("iamabeauty.jpg"));
