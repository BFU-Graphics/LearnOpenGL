...
/*    std::array<unsigned int, 6> transparent_indices = {0, 1, 2,
    ...
    Object Window(transparent_vertices.data(), sizeof(transparent_vertices), plane_indices.data(), sizeof(plane_indices));
    Texture texture3(MY_TEXTURE_DIR + std::string("window.png"));
