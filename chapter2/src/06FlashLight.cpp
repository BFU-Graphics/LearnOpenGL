...
auto main() -> int
{
    ...
    Shader shader(MY_SHADER_DIR + std::string("04shader_vertex.glsl"), MY_SHADER_DIR + std::string("06shader_fragment.glsl"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /// light properties
        shader.set_vec3("light.ambient", 0.1f, 0.1f, 0.1f);
