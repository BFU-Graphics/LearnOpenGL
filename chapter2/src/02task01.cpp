...
auto main() -> int
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /// light properties
        shader.set_vec3("light.ambient", 1.0f, 1.0f, 1.0f); // note that all light colors are set at full intensity
        shader.set_vec3("light.diffuse", 1.0f, 1.0f, 1.0f);
        shader.set_vec3("light.specular", 1.0f, 1.0f, 1.0f);

        ///material properties
        shader.set_vec3("material.ambient", 0.0f, 0.1f, 0.06f);
        shader.set_vec3("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
        shader.set_vec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f); // specular lighting doesn't have full effect on this object's material
