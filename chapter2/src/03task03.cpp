...
auto main() -> int
{
    ...
    Shader shader(MY_SHADER_DIR + std::string("03shader_vertex.glsl"), MY_SHADER_DIR + std::string("03task2shader_fragment.glsl"));
    ...
    Texture diffuseMap(MY_TEXTURE_DIR + std::string("container2.png"));
    Texture specularMap(MY_TEXTURE_DIR + std::string("container2_specular.png"));
    Texture emissionMap(MY_TEXTURE_DIR + std::string("matrix.jpg"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.set_float("matrixlight", (1.0+sin(glfwGetTime()))/2+0.5);
        shader.set_float("matrixmove", glfwGetTime());
