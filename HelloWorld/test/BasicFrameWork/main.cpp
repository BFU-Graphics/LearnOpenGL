...
void process_input(GLFWwindow *window, HelloWorld::World *world, Camera *camera, float deltaTime) {
...
int main() {
    ...
    //HelloWorld::Shader shader("camera.vert", "camera.frag");
    HelloWorld::Shader lightingShader("materials.vert", "materials.frag");
